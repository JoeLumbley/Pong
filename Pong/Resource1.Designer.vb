...
Namespace My.Resources
    ...
    Friend Class Resource1
        ...
        '''  Looks up a localized resource of type System.Byte[].
        '''</summary>
        Friend Shared ReadOnly Property hit4() As Byte()
            Get
                Dim obj As Object = ResourceManager.GetObject("hit4", resourceCulture)
                Return CType(obj,Byte())
            End Get
        End Property
        ...
        '''  Looks up a localized resource of type System.Byte[].
        '''</summary>
        Friend Shared ReadOnly Property PauseLoop() As Byte()
            Get
                Dim obj As Object = ResourceManager.GetObject("PauseLoop", resourceCulture)
                Return CType(obj,Byte())
            End Get
        End Property
        ...
        '''  Looks up a localized resource of type System.Byte[].
        '''</summary>
        Friend Shared ReadOnly Property Score() As Byte()
            Get
        ...
        '''  Looks up a localized resource of type System.Byte[].
        '''</summary>
        Friend Shared ReadOnly Property StartLoop() As Byte()
            Get
                Dim obj As Object = ResourceManager.GetObject("StartLoop", resourceCulture)
                Return CType(obj,Byte())
            End Get
        End Property
        ...
        '''  Looks up a localized resource of type System.Byte[].
        '''</summary>
        Friend Shared ReadOnly Property TechNoir() As Byte()
            Get
                Dim obj As Object = ResourceManager.GetObject("TechNoir", resourceCulture)
                Return CType(obj,Byte())
            End Get
        End Property
    End Class
